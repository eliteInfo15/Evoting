    ...
    <div class="card" id="card" style="box-shadow: none">
        ...
        <div class="card-body">
            ...
            <div class="md-form">
              <div class="col-md-8 inputGroupContainer">
            <i class="fa fa-user prefix"></i>
                <input type="text" id="candidate_name" class="form-control" readonly required name="cnd_name" value="<?php echo $data['candidate_name'] ?>">
         ...
         <div class="md-form">
          <div class="col-md-8 inputGroupContainer">
              <i class="fa fa-phone prefix"></i>
                <input type="text" id="candidate_phone" class="form-control" readonly required name="cnd_phone" value="<?php echo $data['candidate_phone']?>">
             ...
             <div class="md-form">
              ...
              <i class="fa fa-envelope prefix"></i>
                <input type="text" id="candidate_email" class="form-control" readonly required name="cnd_mail" value="<?php echo $data['candidate_email'] ?>">
...
<div class="md-form pb-3" style="margin-bottom: 0">
  ...
  <img class="img-responsive" src="<?php echo($data["candidate_pic"]) ?>">
</div>
             </div>
</div>
