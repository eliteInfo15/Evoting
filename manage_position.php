...
<div class="tabs-wrapper"> 
    <ul class="nav classic-tabs tabs-white nav-justified" role="tablist">
        <li class="nav-item" style="margin-left: 0">
            <a class="nav-link waves-light active" data-toggle="tab" href="#panel51" role="tab"><i class="fa fa-eye" aria-hidden="true" style="font-size: 30px;vertical-align: middle;"></i> &nbsp;&nbsp;View Position</a>
        </li>
        <li class="nav-item">
            <a class="nav-link waves-light" data-toggle="tab" href="#panel52" role="tab"><i class="fa  fa-user-plus" aria-hidden="true" style="font-size: 30px;vertical-align: middle;"></i> &nbsp;&nbsp;Add Positions</a>
        </li>
...
<div class="tab-content card">
      ...
      <div class="card" style="//margin: 0px auto; //width: 50%;box-shadow: none">
        ...
        <div class="card-body">
            <!--Title-->
             ...
             $select_qry="select * from position;";
    ...
    <tbody align="center">
        <?php while ($row=mysqli_fetch_assoc($result_data)) {
              ...
              <a href="" data-toggle="modal" data-target="#update_modal_position"  class="btn btn-success btn-sm" onclick="modal_update_position('Update','<?php echo $row['position_id'];?>')"><i class="fa fa-pencil"></i> Edit</a>
              
              <a  href="#" data-toggle="modal" data-target="#centralModalDanger" class="btn btn-danger btn-sm" onclick="modal_delete_position('Update','<?php echo $row['position_id'];?>')"  ><i class="fa fa-times"></i> Remove</a>
            </td>
        </tr>
<?php } ?>
...
<!--Table-->
    ...
    <div class="card" id="card" style="box-shadow: none">
        ...
        <div class="card-body">
            ...
            <!--Body-->
            <form class="" method="post" id="add_pos">

             
            <div class="md-form">
               <div class="col-md-8 inputGroupContainer">
            <i class="fa fa-user prefix"></i>
                <input type="text" id="position_id_val" class="form-control" required name="position_id">
                <label for="position_id_val">Position id</label>
            </div>
            </div>
            <div class="md-form">
               <div class="col-md-8 inputGroupContainer">
            <i class="fa fa-user prefix"></i>
                <input type="text" id="position_name_val" class="form-control" required name="position_name">
                <label for="position_name_val">Position name</label>
            </div>
             </div>
            
             
            <div class="  col-lg-4 text-center">
                <button type="submit" class="btn blue-gradient btn-block btn-rounded z-depth-2" style="margin-right: auto;margin-left: auto">Add Position</button>
            </div>
            </form>
...
<!-- Central Modal Medium Danger -->
 ...
 submitHandler: function(validator, form, submitButton) {
           var pos_id= $('#position_id').val(); /* GET THE VALUE OF THE SELECTED DATA */
      var pos_name= $('#position_name').val(); /* STORE THAT TO A DATA STRING */
    var dataString="pos_id="+pos_id+"&pos_name="+pos_name;
      $.ajax({ /* THEN THE AJAX CALL */
        type: "POST", /* TYPE OF METHOD TO USE TO PASS THE DATA */
        url: "add_position.php", /* PAGE WHERE WE WILL PASS THE DATA */
      ...
      */  -->
      <script type="text/javascript">
         ...
         function modal_delete_position(param1 ,param2)
{
...
function modal_update_position(param1 ,param2)
{
  document.getElementById('modal-body-update').innerHTML = 
    '<iframe id="frame1" src="updateposition.php?id='+param2+'" width="100%" height="400" frameborder="0"></iframe>';
  document.getElementById('modal-tablesLabel_question').innerHTML = param1.replace("_"," ");
}
...
<script type="text/javascript">
    ...
    $('#deleteForm').bootstrapValidator({
        ...
        feedbackIcons: {
          ...
          submitHandler: function(validator, form, submitButton) {
               var pos_id= $('#modal-input-delete').val();

 /* GET THE VALUE OF THE SELECTED DATA */
      var dataString = "pos_id="+pos_id; /* STORE THAT TO A DATA STRING */

      $.ajax({ /* THEN THE AJAX CALL */
        type: "POST", /* TYPE OF METHOD TO USE TO PASS THE DATA */
        url: "deleteposition_ajax.php", /* PAGE WHERE WE WILL PASS THE DATA */
        data: dataString, /* THE DATA WE WILL BE PASSING */
        success: function(result){
             ...
             location.href="manage_position.php";
    ...
    $('#add_pos').bootstrapValidator({
        ...
        feedbackIcons: {
          ...
          submitHandler: function(validator, form, submitButton) {
               var pos_id= $('#position_id_val').val();
                 var pos_name= $('#position_name_val').val();
 /* GET THE VALUE OF THE SELECTED DATA */
      var dataString = "pos_id="+pos_id+"&pos_name="+pos_name; /* STORE THAT TO A DATA STRING */
      ...
      $.ajax({ /* THEN THE AJAX CALL */
        ...
        success: function(result){
             ...
             if(result==1) {
              ...
              //$('#updated_modal').modal('show');
              $('#position_id_val').val("");
                 $('#position_name_val').val("");
             $('#centralModalSuc').modal('show');
             
             
             }
             else if (result==20) {
              alert('position id already exists');
             }     /* GET THE TO BE RETURNED DATA */
            /* THE RETURNED DATA WILL BE SHOWN IN THIS DIV */
