...
<div class="tabs-wrapper"> 
    <ul class="nav classic-tabs tabs-white nav-justified" role="tablist">
        <li class="nav-item" style="margin-left: 0">
            <a class="nav-link waves-light active" data-toggle="tab" href="#panel51" role="tab"><i class="fa fa-eye" aria-hidden="true" style="font-size: 30px;vertical-align: middle;"></i> &nbsp;&nbsp;View Parties</a>
        </li>
        <li class="nav-item">
            <a class="nav-link waves-light" data-toggle="tab" href="#panel52" role="tab"><i class="fa  fa-user-plus" aria-hidden="true" style="font-size: 30px;vertical-align: middle;"></i> &nbsp;&nbsp;Add Party</a>
        </li>
    ...
    <tbody align="center">
        <?php while ($row=mysqli_fetch_assoc($result_data)) {
                    ?>
                       ...
                       <tr>
                        <th scope="row"><?php echo $row["party_id"]; ?></th>
                        <td><?php echo $row["party_name"]; ?></td>
                        
                        
                        <td>
                          
              <a href="" data-toggle="modal" data-target="#update_modal_position"  class="btn btn-success btn-sm" onclick="modal_update_party('Update','<?php echo $row['party_id'];?>')"><i class="fa fa-pencil"></i> Edit</a>
              
              <a  href="#" data-toggle="modal" data-target="#centralModalDanger" class="btn btn-danger btn-sm" onclick="modal_delete_party('Update','<?php echo $row['party_id'];?>')"  ><i class="fa fa-times"></i> Remove</a>
            </td>
        </tr>
<?php } ?>
   ...
   <section class="form-elegant">
    ...
    <div class="card" id="card" style="box-shadow: none">
        ...
        <div class="card-body">
            ...
            <!--Body-->
             <form class="" method="post" id="add_party">

             
            <div class="md-form">
               <div class="col-md-8 inputGroupContainer">
            <i class="fa fa-user prefix"></i>
                <input type="text" id="party_id_val" class="form-control" required name="party_id">
                <label for="party_id_val">Party id</label>
            </div>
            </div>
            <div class="md-form">
               <div class="col-md-8 inputGroupContainer">
            <i class="fa fa-user prefix"></i>
                <input type="text" id="party_name_val" class="form-control" required name="party_name">
                <label for="party_name_val">Party name</label>
            </div>
             </div>
            
             
            <div class="  col-lg-4 text-center">
                <button type="submit" class="btn blue-gradient btn-block btn-rounded z-depth-2" style="margin-right: auto;margin-left: auto">Add Party</button>
            </div>
            </form>
  ...
  <div class="modal-dialog modal-notify modal-success" role="document">
      ...
      <div class="modal-content">
          ...
          <div class="modal-footer justify-content-center">
              ...
              <a href="manage_party.php" type="button" class="btn btn-outline-success waves-effect" >Close</a>
          </div>
      </div>
      <!--/.Content-->
  </div>
...
<script type="text/javascript">
         ...
         function modal_delete_party(param1 ,param2)
{
...
function modal_update_party(param1 ,param2)
{
  document.getElementById('modal-body-update').innerHTML = 
    '<iframe id="frame1" src="updateparty.php?id='+param2+'" width="100%" height="400" frameborder="0"></iframe>';
  document.getElementById('modal-tablesLabel_question').innerHTML = param1.replace("_"," ");
}
    ...
    $('#deleteForm').bootstrapValidator({
        ...
        feedbackIcons: {
          ...
          submitHandler: function(validator, form, submitButton) {
               var party_id= $('#modal-input-delete').val();

 /* GET THE VALUE OF THE SELECTED DATA */
      var dataString = "party_id="+party_id; /* STORE THAT TO A DATA STRING */

      $.ajax({ /* THEN THE AJAX CALL */
        type: "POST", /* TYPE OF METHOD TO USE TO PASS THE DATA */
        url: "deleteparty_ajax.php", /* PAGE WHERE WE WILL PASS THE DATA */
        ...
        success: function(result){
             ...
             location.href="manage_party.php";
    ...
    $('#add_party').bootstrapValidator({
        ...
        feedbackIcons: {
          ...
          submitHandler: function(validator, form, submitButton) {
               var party_id= $('#party_id_val').val();
                 var party_name= $('#party_name_val').val();
 /* GET THE VALUE OF THE SELECTED DATA */
      var dataString = "party_id="+party_id+"&party_name="+party_name; /* STORE THAT TO A DATA STRING */

      $.ajax({ /* THEN THE AJAX CALL */
        type: "POST", /* TYPE OF METHOD TO USE TO PASS THE DATA */
        url: "add_party.php", /* PAGE WHERE WE WILL PASS THE DATA */
        data: dataString, /* THE DATA WE WILL BE PASSING */
        success: function(result){
             if(result==1) {
              //$('#update_modal_position').modal('hide');
