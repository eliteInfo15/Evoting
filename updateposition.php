...
if($_GET['id']!="" )
{
  ...
  $qry="select * from position where position_id='".$id."'";
    ...
    <div class="card" id="card" style="box-shadow: none">
        ...
        <div class="card-body">
            ...
            <i class="fa fa-user prefix"></i>
                <input type="text" id="pos_id" class="form-control" readonly required name="pos_id" value="<?php echo $data['position_id'] ?>">
            ...
            <div class="md-form">
              <div class="col-md-8 inputGroupContainer">
            <i class="fa fa-user prefix"></i>
                <input type="text" id="pos_name" class="form-control"  required name="pos_name" value="<?php echo $data['position_name'] ?>">
            ...
            <div class="  col-lg-4 text-center">
                <button type="submit" class="btn blue-gradient btn-block btn-rounded z-depth-2" style="margin-right: auto;margin-left: auto" name="update_btn">Update position</button>
            </div>
...
var pos_name= $('#pos_name').val();
 ...
 /* GET THE VALUE OF THE SELECTED DATA */
      ...
      $.ajax({ /* THEN THE AJAX CALL */
        ...
        url: "updateposition_ajax.php", /* PAGE WHERE WE WILL PASS THE DATA */
